...
object DataPahlawan {
    private val namaPahlawan = arrayOf("Ahmad Dahlan",
    "Ahmad Yani",
    "Sutomo",
    "Gatot Soebroto",
    "Ki Hadjar Dewantara",
    ...
    private val detailPahlawan = arrayOf("Salah seorang ulama dan khatib terkemuka di Masjid Besar Kasultanan Yogyakarta pada masa itu, dan ibu dari K.H. Ahmad Dahlan adalah puteri dari H. Ibrahim yang juga menjabat penghulu Kesultanan Ngayogyakarta Hadiningrat pada masa itu. KH. Ahmad Dahlan telah mempelopori kebangkitan ummat Islam untuk menyadari nasibnya sebagai bangsa terjajah yang masih harus belajar dan berbuat.",
    ...
    private val gambarPahlawan = intArrayOf(R.drawable.ahmad_dahlan,
    ...
    val listData: ArrayList<Pahlawan>
    get(){
        val list = arrayListOf<Pahlawan>()
        for (position in namaPahlawan.indices){
            val pahlawan = Pahlawan()
            pahlawan.nama = namaPahlawan[position]
            pahlawan.detail = detailPahlawan[position]
            pahlawan.foto = gambarPahlawan[position]
            list.add(pahlawan)
        }
        return list
    }
